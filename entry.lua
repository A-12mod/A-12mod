...
InputProfiles =
	{
		["VSN_YF12A"] = current_mod_path .. '/Input/RA-5C',
	},
})
----------------------------------------------------------------------------------------
...
----------------------------------------------------------------------------------------
--make_flyable('RA-5C',current_mod_path..'/Cockpit/Scripts/',F22A, current_mod_path..'/Comm.lua')--make_flyable('RA-5C',current_mod_path..'/Cockpit/KneeboardRight/',{nil, old = 6}, current_mod_path..'/Comm.lua')----------------------------------------------------------dofile(current_mod_path.."/LUA/Views_F15Pit.lua")
